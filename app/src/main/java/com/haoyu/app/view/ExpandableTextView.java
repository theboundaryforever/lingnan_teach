...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    protected Button mButton; // Button to expand/collapse
    ...
    private String mExpandText;  //展开文字
    private String mCollapseText;  // 收起文字
    ...
    public void onClick(View view) {
        ...
        if (mCollapsed) {
            ...
            if (mExpandDrawable != null) {
                mButton.setCompoundDrawables(null, null, mExpandDrawable, null);
            }
        } else {
            mButton.setText(mCollapseText);
            if (mCollapseDrawable != null) {
                mButton.setCompoundDrawables(null, null, mCollapseDrawable, null);
            }
        }
...
//
//        if (mExpandDrawable == null) {
//            mExpandDrawable = getDrawable(getContext(), R.drawable.course_zhankai);
//        }
//        if (mCollapseDrawable == null) {
//            mCollapseDrawable = getDrawable(getContext(), R.drawable.course_shouqi);
//        }
        if (mExpandDrawable != null) {
