...
public class MyMarkActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initData() {
        String url
                = Constants.OUTRT_NET + "/" + aid + "/teach/m/assignment/mark?assignmentRelationId=" + relationId;
            ...
            for (int i = 0; i < receiveAssignment.getResponseData().size(); i++) {
                ...
                if (role != null) {
                    if (role.contains("teacher")) {
                        url = Constants.OUTRT_NET + "/" + aid + "/teach/unique_uid_" + uid + "/m/assignment/mark/" + id;
                    } else
                        url = Constants.OUTRT_NET + "/" + aid + "/study/unique_uid_" + uid + "/m/assignment/mark/" + id;
                }
                try {
    ...
    private void shakeAssignment() {
        String url = Constants.OUTRT_NET + "/" + aid + "/teach/unique_uid_" + uid + "/m/assignment/mark?assignment.id=" + assignmentId + "&assignmentRelationId=" + relationId;
