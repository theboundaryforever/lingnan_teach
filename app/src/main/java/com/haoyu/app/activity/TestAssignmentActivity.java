...
public class TestAssignmentActivity extends BaseActivity implements OnClickListener{
    ...
    public void setListener() {
        ...
        mReBack.setOnClickListener(context);
    ...
    private void getDescData() {
        ...
        OkHttpClientManager.getAsyn(context, url, new OkHttpClientManager.ResultCallback<AppActivityViewResult>() {
