...
public class TestMyAssignmentActivity extends BaseActivity  {
    ...
    public void initData() {
        ...
        if (state != null && state.equals("not_attempt")) {
            stateImage.setImageResource(R.drawable.assignment_uncommitted);
    ...
    private SpannableStringBuilder setMsgColor(String msg) {
        ...
        mSpannableStringBuilder.setSpan
                (new ForegroundColorSpan(this.getResources().getColor(R.color.orange)), startIndex, endIndex, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
