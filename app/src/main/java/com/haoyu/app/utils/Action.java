...
public class Action {
    ...
    public static String CREATE_COURSE_QUESTION = "CREATE_COURSE_QUESTION";  //创建课程问答
    public static String ALTER_COURSE_QUESTION = "ALTER_COURSE_QUESTION";  //修改课程问答
    public static String DELETE_COURSE_QUESTION = "DELETE_COURSE_QUESTION";  //删除课程问答
    public static String CREATE_COURSE_ANSWER = "ANSWER_COURSE_QUESTION";  //回答课程问题
    public static String ALTER_COURSE_ANSWER = "ALTER_COURSE_ANSWER";   //修改回答
    public static String DELETE_COURSE_ANSWER = "DELETE_COURSE_ANSWER";  //删除回答
