...
public class MPermissionUtils {
    ...
    private static void requestPermissions(Object object, int requestCode
            , String[] permissions, OnPermissionListener mOnPermissionListener) {
     ...
     */
    public static void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults,OnPermissionListener mOnPermissionListener) {
    ...
    public static void showTipsDialog(final Context context) {
        ...
        dialog.setMessage("当前应用缺少必要权限，该功能暂时无法使用。如若需要，请单击【确定】按钮前往设置中心进行权限授权。");
