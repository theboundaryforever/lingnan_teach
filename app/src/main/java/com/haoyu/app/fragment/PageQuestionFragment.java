...
public class PageQuestionFragment extends BaseFragment {
    ...
    private RadioButton rb_allQuestion;
    private Button bt_createQA;
    ...
    public void initView(View view) {
        ...
        rb_allQuestion = view.findViewById(R.id.rb_allQuestion);
        bt_createQA = view.findViewById(R.id.bt_createQA);
    }
